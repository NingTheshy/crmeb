...
public class StoreOrderVerificationImpl implements StoreOrderVerification {
    ...
    public StoreStaffTopDetail getOrderVerificationData() {
        ...
        storeStaffTopDetail.setOrderCount(dao.selectCount(lqwOrderCount).intValue());
        //订单支付没有退款 支付总金额
